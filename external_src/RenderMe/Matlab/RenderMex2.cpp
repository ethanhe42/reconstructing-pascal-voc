...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  int duh = OSMesaMakeCurrent(ctx, (void*)pbuffer, GL_UNSIGNED_BYTE, m_width, m_height);
  mexPrintf("%d", duh);
  if (!duh) {
    mexErrMsgTxt("OSMesaMakeCurrent failed!: ");
    mexPrintf("OSMesaMakeCurrent failed!: ");
  }
